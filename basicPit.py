...
# -------------------------------
def send_attitude_target(thrust, roll, pitch, yaw):
    """
...
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.1')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.1, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.2')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.2, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.3')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.3, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.4')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.4, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.5')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.5, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)

print('0.6')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.6, roll=0, pitch=0, yaw=0)
    time.sleep(0.1)
...
print('pitch forward'))
for i in range(2):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.6, roll=0, pitch=5, yaw=0)
    time.sleep(0.1)
