...
3. Arms the motors
4. Throttles the motors at 15% for 6 seconds
5. Throttles the motors at 12% for 6 seconds
6. Enters land mode
7. Disarms as a result of land mode
"""
...
print('0.12')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.12)
    time.sleep(0.1)
