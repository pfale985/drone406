...
NOTE: Make sure that GUID_OPTIONS = 8 in Mission Planner

This code goes through the following steps
1. Connects to the FC
2. Sets flight mode to GUIDED_NOGPS
3. Arms the motors
4. Throttles the motors at 15% for 3 seconds
5. Throttles the motors at 14% for 3 seconds
6. Throttles the motors at 13% for 3 seconds
7. Enters land mode
8. Disarms as a result of land mode
"""
...
print('0.15')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.15)
    time.sleep(0.1)
  
print('0.14')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.14)
    time.sleep(0.1)
  
print('0.13')
for i in range(20):  # ~3 seconds at 10Hz
    send_attitude_target(thrust=0.13)
    time.sleep(0.1)
